...
- Switches between a Month grid and a Day view with a compact toggle. Day view hides the grid, steps one day at a time, and shows the selected day's full scrollable agenda including event locations. `Today` opens today in Day view.
